...
namespace Project_Hulk
{
	...
	class SyntaxError : SystemErrors
	{
		...
		//diferentes constructores porque env�o diferentes mensajes y no necesito todos los parametros
	...
	class DefaultError : SystemErrors
	{
		...
		public override void PrintError()
		{
			...
			else if (ProblemKind == "semicolon")
			{
				System.Console.WriteLine("! DEFAULT ERROR: Missing ' ; '.");
			}
			Console.ForegroundColor = ConsoleColor.Green;
		}
	}
